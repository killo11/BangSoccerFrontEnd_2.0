...
module.exports = function (grunt) {
    ...
    var fileConfig = {
        ...
        vendor_files: {
            js: [
                ...
                'vendor/zSlider/dist/zSlider.min.js',
                'vendor/moment/min/moment-with-locales.min.js',
                'vendor/moment/min/moment.js',
    ...
    grunt.registerTask('buildmock', [
        'clean:all', 'html2js', 'jshint', 'coffeelint', 'coffee', 'less:build',
        'concat:build_css', 'copy:build_app_assets', 'copy:build_vendor_assets',
        'copy:build_appjs', 'copy:buildmock_vendorjs', 'ngAnnotate:build', 'index:mock'
    ]);
    ...
    grunt.registerMultiTask('index', 'Process index.html template', function () {
        ...
        grunt.file.copy('src/index.html', this.data.dir + '/index.html', {
            process: function (contents, path) {
                var serverPath = grunt.option('domain');
